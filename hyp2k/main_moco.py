...
def main_worker(gpu, ngpus_per_node, args):
    ...
    model = builder.HyperMoCo(models.__dict__[args.arch],
                              args.moco_dim,
                              args.moco_k,
                              args.moco_m,
                              args.moco_t,
    ...
    scheduler = torch.optim.lr_scheduler.StepLR(optimizer, 600, 0.987)
